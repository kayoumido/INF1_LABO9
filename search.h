...
std::vector<std::string>::iterator linearSearch(const std::vector<std::string>::iterator &START, const std::vector<std::string>::iterator &END, std::string searchWord);
std::size_t dichotomySearch(const std::vector<std::string> &DICT, std::string searchWord);
std::vector<std::string>::iterator binarySearch(std::vector<std::string>::iterator startIt, std::vector<std::string>::iterator endIt, std::string searchWord);
bool recursiveBinarySearch(std::vector<std::string>::iterator startIt, std::vector<std::string>::iterator endIt, std::string searchWord);
